...
<a href='uapmenu.php'><button>Kembali Ke Menu Pilihan</button></a></br>
<br>
<a href='uapcari.php'><button>Lihat Data Keseluruhan</button></a></br>
<br>
<form action="" method="POST" >
			<input type="text" name="keyword" size="50" autofocus placeholder="Masukkan nama penumpang sebagai keyword pencarian.." autocomplete="off">
...
if(isset($_POST['keyword'])){
 ...
 $query = "SELECT * FROM UAPKAI WHERE NAMA LIKE '%$keyword%'"; 
} else{
	$query = "SELECT * ".
             "FROM UAPKAI";
} 
